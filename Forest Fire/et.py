...
feature_train, feature_test, target_train, target_test = train_test_split(features, target, test_size=0.0, random_state=42)
...
df.to_csv("./file60000.csv", sep=',',index=False)